...
def main():
    # parse options
    cfg = parse_args()  # parse config file         # 默认添加--config的yaml ./configs/assets.yaml  ./configs/base.yaml
    print("cfg.TRAIN.DATASETS", cfg.TRAIN.DATASETS)
    GENRE_NUM = cfg.FINEDANCE.GENRE_NUM

    # create logger
    logger, final_outdir = create_logger(cfg, phase="train")
    ...
    # optimizer
    metric_monitor = {
        # "rot_smoothl1": "Metrics/rot_smoothl1loss",
        # "rot_l1": "Metrics/rot_l1loss",
        # "xyz_l1": "Metrics/xyz_l1loss"  
    }
